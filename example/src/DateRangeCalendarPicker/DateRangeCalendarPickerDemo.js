...
import { DateRangeCalendarPicker, DateRangeCalendarPickerInput } from 'react-datetime-range-super-picker';
...
import { useRangePickerProps } from './daterangecalendarpicker.hooks';
...
export default () => {
    ...
    return (
		<div className="timepicker-wrapper">
			<div className='heading font-small'>Date Range Calendar Picker</div>
					...
					<div className='picker-wrapper'>
						...
						{isInput ? 
							<div className="range-picker-input-wrapper">
								<DateRangeCalendarPickerInput {...TProps} />
							</div>
							:
